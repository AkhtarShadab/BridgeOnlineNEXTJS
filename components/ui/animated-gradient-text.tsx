/**
 * AnimatedGradientText — Magic UI, adapted for Tailwind 3.4
 * (v4 `bg-linear-to-r from-(--x)` syntax → v3 arbitrary values).
 * The `gradient` keyframe lives in tailwind.config.ts.
 */
